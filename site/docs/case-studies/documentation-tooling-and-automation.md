...
<pre className="system-flow">repeated manual task
    │
    ▼
validate the workflow and its value
    │
    ▼
automate the stable part
    │
    ▼
review results and improve the standard</pre>
...
<div className="content-grid">
  <section className="content-card"><h3>Governance tools</h3><p>Freshness tracking, change monitoring, and documentation diff triage.</p></section>
  <section className="content-card"><h3>Content tools</h3><p>Support for structured content, style checks, media management, and repeated review work.</p></section>
  <section className="content-card"><h3>Workflow automation</h3><p>Task setup, collaboration steps, publishing support, and shared tool catalogs.</p></section>
  <section className="content-card"><h3>Quality systems</h3><p>Codified patterns that help make review and submission work more consistent.</p></section>
</div>
